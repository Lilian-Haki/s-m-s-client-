...
import { DashboardOutlined,UserOutlined, ContainerOutlined, CarryOutOutlined, BookOutlined,DollarOutlined,SettingOutlined,BellOutlined,LogoutOutlined } from '@ant-design/icons';
    ...
    <div className="flex min-h-screen">
      ...
      <header className='justify-items-end bg-gray-600 p-4'>
          ...
          <div className="flex space-x-4">
            <span className="text-gray-800 hover:text-black"><BellOutlined style={{fontSize: '24px'}}/></span>
            <span className="text-gray-800 hover:text-black"><UserOutlined style={{fontSize: '24px'}}/></span>
            <span className="text-gray-800 hover:text-black"><SettingOutlined style={{fontSize: '24px'}}/></span>
      ...
      <main className="flex-1 p-8 bg-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="bg-slate-300 p-6 rounded-lg shadow">
            <h2 className="text-xl text-slate-700 font-semibold mb-2">Total Students</h2>
            <p className="text-3xl text-gray-600 font-bold">320</p>
          </div>
          <div className="bg-slate-300 p-6 rounded-lg shadow">
            <h2 className="text-xl text-slate-700 font-semibold mb-2">Total Teachers</h2>
            <p className="text-3xl text-gray-600 font-bold">45</p>
          </div>
          <div className="bg-slate-300 p-6 rounded-lg shadow">
            <h2 className="text-xl text-slate-700 font-semibold mb-2">Total Courses</h2>
            <p className="text-3xl text-gray-600 font-bold">15</p>
          </div>
        </div>
      </main>
